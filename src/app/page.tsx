...
export default function Home() {
  ...
  return (
    <main className="bg-white text-black min-h-screen">
      ...
      {/* Hero Slider Section - White Theme */}
      <section className="relative h-[80vh] w-full overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          >
            <Image src={images[index]} alt="Hero" fill className="object-cover" />
        ...
        <div className="relative z-10 text-center px-6 h-full flex flex-col items-center justify-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
            ...
            <h1 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter mb-6 text-black">
              Blackswon<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800">Safety Services</span>
            </h1>
  ...
  <div className="bg-gray-50 border border-gray-100 p-12 rounded-[2rem] flex flex-col md:flex-row gap-12 items-center">
    ...
    <div className="flex-1 w-full h-[300px] bg-gray-200 rounded-2xl border border-gray-100 relative overflow-hidden">
      <Image src="/hero1.png" alt="Blackswon About" fill className="object-cover" />
    </div>
  </div>
</section>

      {/* Products Section */}
      <section className="py-15 px-0 max-w-6xl mx-auto">
